      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.card}>
          <Text style={styles.cardText}>
            Run a full system check to verify that the Database, Notifications, Device Logic, and
            Analytics modules are functioning correctly.
          </Text>
          ...
          {results.map((result, index) => (
            <View key={index} style={styles.resultItem}>
              <View style={styles.resultHeader}>
                ...
                {result.duration && <Text style={styles.duration}>{result.duration}ms</Text>}
              </View>
              {result.message && (
                <Text
                  style={[
