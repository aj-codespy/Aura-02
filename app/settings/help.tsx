  ...
  const faqs = [
    {
      ...
      answer:
        'Go to the Devices tab and tap the + button. You can scan a QR code or manually enter device details.',
    },
    {
      question: 'How do I create a schedule?',
      answer:
        'Navigate to the Schedule tab, tap the + button, select a device, set the time and days, and save.',
    },
    {
      question: 'What does the "Live" badge mean?',
      answer:
        'It indicates that the app is connected to the local server and receiving real-time updates.',
    },
  ];
