  ...
  showPermissionDeniedAlert: (type: PermissionType) => {
    const messages = {
      camera: {
        ...
        message:
          'To scan QR codes and pair devices, please enable camera access in your device settings.',
      },
      notifications: {
        title: 'Notifications Required',
        message:
          'To receive critical alerts about your devices, please enable notifications in your device settings.',
      },
      localNetwork: {
        title: 'Local Network Access Required',
        message:
          'To discover and control devices on your network, please enable local network access in your device settings.',
      },
    };
